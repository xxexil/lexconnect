<div class="lp-card">
    ...
    <div style="display:flex;gap:12px;flex-wrap:wrap;align-items:end;padding:0 22px 18px;">
        <div style="flex:1;min-width:240px;">
            <label for="firmEarningsSearch" style="display:block;font-size:.8rem;font-weight:600;color:#6c757d;margin-bottom:6px;">Search</label>
            <input
                type="text"
                id="firmEarningsSearch"
        ...
        <div style="min-width:180px;">
            <label for="firmEarningsStatus" style="display:block;font-size:.8rem;font-weight:600;color:#6c757d;margin-bottom:6px;">Status</label>
            <select id="firmEarningsStatus" wire:model.live="status" style="width:100%;height:42px;padding:0 14px;border:1px solid #d9e2ef;border-radius:8px;font-size:.92rem;color:#1e2d4d;background:#fff;">
        ...
        <div style="min-width:180px;">
            <label for="firmEarningsType" style="display:block;font-size:.8rem;font-weight:600;color:#6c757d;margin-bottom:6px;">Payment Type</label>
            <select id="firmEarningsType" wire:model.live="type" style="width:100%;height:42px;padding:0 14px;border:1px solid #d9e2ef;border-radius:8px;font-size:.92rem;color:#1e2d4d;background:#fff;">
